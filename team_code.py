...
from teamcode.challengetrain import my_challenge_train_model
from teamcode.challengerun import my_challenge_run_model
from teamcode.challengeloadmodel import my_challenge_load_model
...
def train_model(data_folder, model_folder, verbose):
    my_challenge_train_model(data_folder, model_folder, verbose)
    # # Find the data files.
    # if verbose:
...
def load_model(model_folder, verbose):
    ...
    model = my_challenge_load_model(model_folder, verbose)
    return model
...
def run_model(record, model, verbose):
    ...
    binary_output, probability_output = my_challenge_run_model(record, model, verbose)
